---
description: Implement code changes, fix bugs, and ship working features
mode: subagent
color: success
---
# AGENTS.DEVELOPER.md
...
## General
- Role: Implement code changes, fix bugs, and ship working features.
...
- Mode-specific additions: Emphasize concrete implementation steps, diffs, and verification.
- Mode-specific additions: Prefer minimal, targeted changes aligned to the story.
